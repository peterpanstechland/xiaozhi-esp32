...
class SilicoreLiteBoard : public WifiBoard {
private:
    ...
    void InitializeSsd1306Display() {
        ...
        display_ = new SilicoreC3Oled(panel_io_, panel_, DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_MIRROR_X, DISPLAY_MIRROR_Y,
...
public:
    SilicoreLiteBoard() : boot_button_(BOOT_BUTTON_GPIO) {  
...
DECLARE_BOARD(SilicoreLiteBoard); 

#endif // !defined(USE_ML307_BOARD)
...
public:
    PressToTalk() : Thing("PressToTalk", "控制对话模式，一种是长按对话，一种是单击后连续对话。") {
        ...
        properties_.AddBooleanProperty("enabled", "true 表示长按说话模式，false 表示单击说话模式", []() -> bool {
            auto board = static_cast<SilicoreLiteBoard*>(&Board::GetInstance());
